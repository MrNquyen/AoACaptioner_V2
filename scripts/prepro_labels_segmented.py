"""
  Preprocess a segmented json dataset into hdf5/json files for use in data_loader.lua
  ...
  /images is (N,3,256,256) uint8 array of segmented image data in RGB format
...
def build_vocab(imgs, params):
  ...
  print('max length sentence in segmented data: ', max_len)
...
if __name__ == "__main__":
  ...
  para = {
    ...
    # Ouput json
    'output_json_path': f'{save_dir}\\save_input\\data_segmented.json',
    # Output_h5
    'output_h5': f'{save_dir}\\save_input\\data_segmented',
    # Image_root
