...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default=f'{data_root_dir}\\save_input\\data_raw.json',
    ...
    parser.add_argument('--input_label_h5', type=str, default=f'{data_root_dir}\\save_input\\data_raw_label.h5',
    ...
    # Training
    parser.add_argument('--train_images_use', type=int, default=-1,
                    help='how many images to use to train? (-1 = all)')

    # Evaluation/Checkpointing
    parser.add_argument('--val_images_use', type=int, default=50,
    ...
    parser.add_argument('--checkpoint_path', type=str, default=f'{data_root_dir}\\ckpt\\aoa_new', 
    ...
    # misc
    parser.add_argument('--id', type=str, default='raw',
...
def add_eval_options(parser):
    ...
    # Save eval
    parser.add_argument('--save_eval_dir', type=str, default=f'{data_root_dir}/evaluation', 
                    help='If calculate loss using ground truth during evaluation')
